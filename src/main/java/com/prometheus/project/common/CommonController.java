...
import com.prometheus.project.common.dictDataValue.service.IDictDataValueService;
...
//    }
    ...
    @Autowired
    private IDictDataValueService dictDataValueService;
     ...
     * @return 参数键值
     */
    @PostMapping("/common/selectDictDataList/{dictType}")
    @ResponseBody
    public AjaxResult selectDictDataList(@PathVariable("dictType") String dictType) {
        DictDataValue dictDataValue = new DictDataValue();
        dictDataValue.setDictTypes(new String[]{dictType});
        AjaxResult ajax = AjaxResult.success();
        ajax.put("data", dictDataValueService.selectDictDataList(dictDataValue));
        return ajax;
    }
